...
(Section~\ref{sect:res_backbones}). It also briefly considers an MLLM-derived
embedding model (Qwen3-VL-Embedding~\cite{bai2025qwen3vl}), which underperforms
in this setting. For reranking it draws on self-supervised visual features from
the DINOv2~\cite{oquab2024dinov2} and DINOv3~\cite{simeoni2025dinov3} families;
the corresponding (negative) result is reported in
Section~\ref{sect:res_rerank}.
