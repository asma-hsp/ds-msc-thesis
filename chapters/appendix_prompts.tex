...
% ---------------------------------------------------------------------
%  Reproduced from scripts/generate_internvl_captions_v9.py, where the prompts
%  are named INSTR_F..J. Thesis label mapping: F=A, G=B, H=C, I=D, J=E.
...
\section*{Instruction\,A --- Adaptive Precision}
\begin{verbatim}
...
\section*{Instruction\,B --- Constraint-Priority}
\begin{verbatim}
You are given an image and a modification text: "relative_caption".
...
\section*{Instruction\,C --- Anti-Noise Contract}
\begin{verbatim}
You are given an image and a modification text: "relative_caption".
...
\section*{Instruction\,D --- Slot-Fill Template}
\begin{verbatim}
You are given an image and a modification text: "relative_caption".
...
\section*{Instruction\,E --- Draft-Refine}
\begin{verbatim}
You are given an image and a modification text: "relative_caption".
