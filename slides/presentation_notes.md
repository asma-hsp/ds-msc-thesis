...
9 backups (23–31). Slides 18–19 are the flex valve: if behind, show only the
...
## 7. Problem formulation and evaluation | 0:55 | cum 4:40
...
relevant. Evaluation checks where the correct targets land in this ranking.
...
## 8. Vision–language models: CLIP and SigLIP | 0:55 | cum 5:35
...
## 9. The baseline: BASIC | 1:00 | cum 6:35
...
## 10. Limitation of the baseline — our proposal | 0:55 | cum 7:30
...
## 11. The captioner: InternVL 3.5-8B | 0:40 | cum 8:10
...
## 12. Designing the instruction | 0:35 | cum 8:45
...
## 13. Effect of the caption branch | 0:45 | cum 9:30
...
## 14. Two refinements: centering and contextualisation | 0:50 | cum 10:20
...
## 15. Adding the steps on top of each other | 0:30 | cum 10:50
...
## 16. Does it transfer? Four frozen backbones | 0:45 | cum 11:35
...
## 17. Our best overall system | 0:40 | cum 12:15
...
## 18. Qualitative example — success | 0:25 | cum 12:40 (flex)
...
## 19. Qualitative example — failure | 0:25 | cum 13:05 (flex)
...
## 20. Limitations and future work | 0:40 | cum 13:45
...
## Q&A map | — | —
Score fusion formulas + Harris penalty → **backup 23**. Full CLIP-L ablation,
every rung (incl. projection and query expansion) → **backup 24**. SigLIP2
ladder (produces 61.98) → **backup 25**. Component contributions — image-only,
text-only, caption-only, product, triplet → **backup 26**. Centering + caption
are complementary → **backup 27**. "The paper reports 34.35 for BASIC" →
**backup 28**. Latency breakdown → **backup 29**. Five instruction strategies,
sample captions → **backup 30**; what each does → **backup 31**.

Metric on slide 7; full pipeline figure on slide 10; backbone table on
slide 16.
...
## 26. Component contributions (CLIP-L)
...
## 27. Centering and the caption are complementary
...
## 30. The five instructions — sample captions
...
## 31. The five instructions — explained
